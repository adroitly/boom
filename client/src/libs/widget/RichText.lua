...
--[[
    * 描述：将文字显示为富文本格式
    * 点击事件：onClieked(key)
    * 例子：恭喜<r>type='Label', content='xxx玩家', fontSize=30, fontColor=cc.c4b(255,255,255,255)</r>获得了
                <r>type='ButtonLabel', content='xxx宝物', index='key', underlineColor=cc.c4b(255,255,255,255)</r>，请鼓掌
...
function M:_parseButton(value)
    local button = Button.new(value.content)
